...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Commoncore', 'Admin']
  ...
  # config.model 'CoreStandard' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your core_standard.rb model definition

  #   # Found associations:

  #     configure :levels, :has_many_association 
  #     configure :grade_levels, :has_many_association 
  #     configure :lesson_plans, :has_and_belongs_to_many_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :statement, :text 
  #     configure :docref_id, :string 
  #     configure :guid, :string 
  #     configure :uri, :string 
  #     configure :related_id, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :dot_notation, :string 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your grade_level.rb model definition

  #   # Found associations:

  #     configure :levels, :has_many_association 
  #     configure :core_standards, :has_many_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your lesson_plan.rb model definition
  ...
  #     configure :lesson_plan_file, :carrierwave 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :user_id, :integer         # Hidden 
  ...
  #     configure :grade_level, :belongs_to_association 
  #     configure :core_standard, :belongs_to_association 

  #   # Found columns:

  #     configure :id, :integer 
  #     configure :grade_level_id, :integer         # Hidden 
  #     configure :core_standard_id, :integer         # Hidden 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
