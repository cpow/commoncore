populate_core_standards = (data) ->
  ...
  for object in data
    do (object) ->
      standard_ul.append("<li style='padding:2px;'><input style='padding-top:0;margin:0;' id='#{object.dot_notation}' name='lesson_plan[core_standard_ids][]' type='checkbox' value='#{object.id}'> <a  href='#' id='#{object.dot_notation}' data-statement='#{object.statement}' class='dot_notation' > #{object.dot_notation}</a></li>")
